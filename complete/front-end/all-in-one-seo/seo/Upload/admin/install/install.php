                ...
                <!-- form start -->
                 ...
                 <div class="box-header"> <br />
                    <h3 class="box-title">License Verification</h3>
                        ...
                        <div class="form-group">
                            <label for="data_sec">Item Purchase Code &nbsp; <small><a target="_blank" href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-can-I-find-my-Purchase-Code-">(It's Nulled)</a>  &nbsp; | &nbsp; <a target="_blank" href="http://api.prothemes.biz/tools/reset.php">(Reset Domain Name)</a></small></label>
                            <input value="nulled-by-AmazCode" style="border-color: #DDDDDD;" type="text" placeholder="nulled-by-AmazCode" name="data_sec" id="data_sec" class="form-control">
                        </div>
                    </div><!-- /.box-body -->
    ...
    <br />  
     ...
     <!-- Main Footer -->
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2020 <a href="http://amazcode.ooo/">AmazCode</a></strong> NO rights reserved --- LOL Just Use it and Love AmazCode.
      </footer>
