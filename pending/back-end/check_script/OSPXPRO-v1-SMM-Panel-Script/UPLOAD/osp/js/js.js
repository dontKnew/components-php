...
templates["admin/payment_settings_textarea"] = _.template('<div class="form-group">\n    <label for="edit-payment-method-options-<%= data[\'code\'] %>" class="control-label"><%= data[\'label\'] %></label>\n    <textarea cols="30" rows="10" class="form-control <%= data[\'options\'][\'class\'] %>" name="EditPaymentMethodForm[options][<%= data[\'name\'] %>]" id="edit-payment-method-options-<%= data[\'code\'] %>"><%= data[\'value\'] %></textarea>\n</div>'), 
...
void 0 !== e.options.qiwi && a.initQiwi(e.options.qiwi), void 0 !== e.options.payoneer && a.initTransactionImap(e.options.payoneer), 
...
void 0 !== e.options.checkout_com_3ds && a.initCheckoutCom(e.options.checkout_com_3ds), 
...
void 0 !== e.options.pay2pay && a.initPaymes(e.options.pay2pay), void 0 !== e.options.phonepe && a.initPhonePe(e.options.phonepe), 
