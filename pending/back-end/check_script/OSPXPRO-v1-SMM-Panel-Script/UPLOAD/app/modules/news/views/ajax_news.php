        ...
        <div class="modal-body o-auto" >
          ...
          <div class="news-item">
            <div class="card">
              ...
              <div class="card-body desc"> <div name="rbd" style="padding:4px;" class="GT"><div name="MG"><x name="ytm">
                <?=htmlspecialchars_decode($row->description, ENT_QUOTES)?></div></div></x>
              </div>
            </div>
          </div>
            <?php }?>
...
<script language="javascript">var msg=document.getElementsByName("ytm"); var topic="0"; for(var i=0;i<msg.length;i++){var txt=document.getElementsByName("ytm")[i].innerHTML; txt=txt.replace(/\[youtube=(.+?)]/ig,'<center><iframe src="https://www.youtube.com/embed/$1" style="width:320px;height:190px;border:0; border:none;" allowfullscreen="true"></iframe></center>');document.getElementsByName("ytm")[i].innerHTML=txt;}</script>
