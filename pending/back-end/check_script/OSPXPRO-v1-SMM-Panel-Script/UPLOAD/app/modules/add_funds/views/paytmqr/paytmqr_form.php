      ...
      <div class="col-md-5">
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <h3 class="card-title"> <?=lang("paytm_QR_confirmation")?></h3>
          </div>
          <div class="card-body">
            <div class="tab-content">
              <form id="paymentFrm" method="post" action="<?=cn($module."/paytmqr/create_payment")?>">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" id="ORDER_ID" name="ORDER_ID" type="text" class="form-control" value="<?=$qrtransaction_id?>">
                  <input type="text" class="form-control" value="<?=$qrtransaction_id?>" disabled>
                </div>
