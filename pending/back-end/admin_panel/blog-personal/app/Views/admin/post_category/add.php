        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Fill up the Post Category Information</div>
                </div>
                <form action="<?= route_to("admin/post-category/add") ?>" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name"  value="<?= old("name") ?>" class="form-control input-solid" >
                        </div>
                        <div class="form-group ">
