...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current"  style="text-transform: capitalize;">Pricing</a> </div>
    <h1  style="text-transform: capitalize;">Pricing</h1>
  </div>
  <div class="container-fluid">  <div class="widget-content"> <a href="packaging.php?action=Add" class="btn btn-success" style="float: right;">Upload Pricing</a> 
