...
$sql="insert into package(name,photo,price,details) 
    value('".$name."','".$newName."','".$price."','".$details."')";
$rs=mysqli_query($con,$sql);
if($rs)
{
$msg="New package has been added successfully.";
$msg=urlencode($msg);
header("Location:package.php?sts=$msg");
}
else
{
$msg=mysql_error();
...
header("Location:package.php?sts=$msg");
      ...
      echo "<meta http-equiv=\"refresh\" content=\"0;URL=package.php?sts=inserted\">";
}
...
$sql="update package set name='".$name."',photo='".$newName."',price='".$price."',details='".$details."' where id='$id'"; 
$rs=mysqli_query($con,$sql);
if($rs)
{
...
mysqli_query($con,"delete from package where id='$_REQUEST[id]'");

header("location:package.php?msg=Deleted");
}   
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current"  style="text-transform: capitalize;">package</a> </div>
    <h1  style="text-transform: capitalize;">package</h1>
  </div>
  <div class="container-fluid">  <div class="widget-content"> <a href="package.php?action=Add" class="btn btn-success" style="float: right;">Add package</a> 
  ...
  $s1="select * from package where id ='$_GET[id]'";
  ...
  $pages->paginate();
  $i=1;
  $sql=mysqli_query($con,"select * from package order by id desc $pages->limit");
  ...
  ?>
                <tr class="odd gradeX">
                  ...
                  <td><img src='photo/<? echo $row["photo"]; ?>' width="50"></td>
                 
                  <td> 

<a href="package.php?action=edit&id=<?=$row['id'];?>" class="label   bg_db">Edit</a> 
